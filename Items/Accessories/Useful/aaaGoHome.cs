...
{
    class aaaGoHome : ModItem //todo proper name
    {
        public override string Texture
        {
            get
            {
                return "AssortedCrazyThings/Items/Accessories/Useful/EverburningCandle"; //temp, delete this when proper texture exists
            }
        }

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("aaaGoHome"); //todo proper name
