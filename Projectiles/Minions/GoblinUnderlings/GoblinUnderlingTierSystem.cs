	...
	public class GoblinUnderlingTierSystem : AssSystem
	{
		...
		public override void PostSetupContent()
		{
			...
			tierStats = new Dictionary<GoblinUnderlingProgressionTierStage, GoblinUnderlingTierStats>
			{
				...
				{ GoblinUnderlingProgressionTierStage.Evil      , new GoblinUnderlingMagicTierStats(ModContent.ProjectileType<GoblinUnderlingWeaponOrb_1>(), 2.8f, 1.4f, 5 , 0.4f , 11, 10f, 1.3f, 300, 48 + 16) },
				{ GoblinUnderlingProgressionTierStage.Skeletron , new GoblinUnderlingMagicTierStats(ModContent.ProjectileType<GoblinUnderlingWeaponOrb_2>(), 2.7f, 1.6f, 5 , 0.45f, 11, 11f, 1.4f, 360, 48 + 24) },
