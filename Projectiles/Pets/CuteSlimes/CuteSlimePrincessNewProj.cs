...
namespace AssortedCrazyThings.Projectiles.Pets.CuteSlimes
{
    public class CuteSlimePrincessNewProj : CuteSlimeBaseProj
    {
        public override string Texture
        {
            get
            {
                return "AssortedCrazyThings/Projectiles/Pets/CuteSlimes/CuteSlimeBlueNewProj"; //temp
            }
        }
        ...
        public override void MorePostDrawBaseSprite(Color lightColor, bool useNoHair)
        {
            ...
            Texture2D image = Mod.GetTexture("Projectiles/Pets/CuteSlimes/CuteSlimePrincessNewProjAddition").Value;
