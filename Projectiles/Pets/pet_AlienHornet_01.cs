...
{
	public class pet_AlienHornet_01 : ModProjectile
	{
		...
		public override void SetDefaults()
		{
			...
			public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
				{
					Texture2D texture = mod.GetTexture("Projectiles/Pets/pet_AlienHornet_01_glowmask");
		...
		public override void AI()
		{
			...
			if (player.dead)
			{
				modPlayer.pet_AlienHornet_01 = false;
			}
			if (modPlayer.pet_AlienHornet_01)
			{
