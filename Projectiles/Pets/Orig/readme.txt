Proposed Idea:
	When using Head Slot items for Cute Slime pets, pick a sprite that matches the pet sprite. For example, Pink's pigtails cause issues with all current hats, so use the variant of the hat sprite assigned to her below. Each hat has been given sprites that fit specific Cute Slimes, some covering more than others. The instructions below will say how much offset is needed, as well as which sprite goes to who. Feel free to rename the sprites as needed.
