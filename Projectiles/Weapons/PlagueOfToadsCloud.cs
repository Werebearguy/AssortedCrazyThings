            ...
            else
            {
                ...
                if (projectile.ai[0] > 10f)
                {
                    ...
                    if (projectile.owner == Main.myPlayer)
                    {
                        ...
                        //speedY = 5f;
                        Projectile.NewProjectile(rainSpawnX, rainSpawnY, 0f, 2.5f, mod.ProjectileType<PlagueOfToadsProj>(), projectile.damage, 0f, projectile.owner, Main.rand.Next(2), Main.rand.NextFloat(0.005f, 0.015f));
                    }
                }
            }
